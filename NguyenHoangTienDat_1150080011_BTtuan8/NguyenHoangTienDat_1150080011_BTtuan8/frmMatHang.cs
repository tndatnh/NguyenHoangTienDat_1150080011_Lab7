...
namespace NguyenHoangTienDat_1150080011_BTtuan8
{
    public partial class frmMatHang : Form
    {
        ...
        private void frmMatHang_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\SQL\QLBanHang.mdf;Integrated Security=True;Connect Timeout=30"; 
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (btnThem.Enabled == true)
            {
                ...
                sql += "VALUES(N'" + txtMaSP.Text.Replace("'", "''") + "', ";
                sql += "N'" + txtTenSP.Text.Replace("'", "''") + "', ";
                sql += "'" + dtpNgaySX.Value.Date.ToString("yyyy-MM-dd") + "', ";
                sql += "'" + dtpNgayHH.Value.Date.ToString("yyyy-MM-dd") + "', ";
                sql += "N'" + txtDonVi.Text.Replace("'", "''") + "', ";
                sql += "" + (string.IsNullOrEmpty(txtDonGia.Text) ? "0" : txtDonGia.Text) + ", ";
                sql += "N'" + txtGhiChu.Text.Replace("'", "''") + "')";
